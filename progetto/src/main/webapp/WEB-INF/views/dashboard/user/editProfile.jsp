...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/userPagesStyle.css?v=2.x">
    ...
    <div style="margin-top: 5%" class="container">
        ...
        <div id="confirmDeleteModal" class="modal">
            <div class="modal-content">
                ...
                <button type="button" class="modal-button" onclick="confirmDelete()">Conferma</button>
            </div>
        </div>
        ...
        <div id="confirmUpdateModal" class="modal">
            <div class="modal-content">
                ...
                <button type="button" class="modal-button" onclick="confirmUpdate()">Conferma</button>
            </div>
        </div>
    </div>
